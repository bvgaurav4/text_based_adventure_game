...
img = ImageTk.PhotoImage(Image.open("castle1.jpg"))
f.create_image(0, 0, anchor=NW, image=img)
d = Button(gg, text="start", fg="orange", bg="purple", font="bold")
img1=ImageTk.PhotoImage(Image.open("ransacked1.jpg"))
img3=ImageTk.PhotoImage(Image.open("bar3.jpg"))
img4=ImageTk.PhotoImage(Image.open("house4.jpg"))
img5=ImageTk.PhotoImage(Image.open("cart1.jpg"))
img7=ImageTk.PhotoImage(Image.open("garden3.jpg"))
img8=ImageTk.PhotoImage(Image.open("app1.jpg"))
...
def start():
        ...
        def check1():
            ...
            def last():
                ...
                def s7():
                    ...
                    ic1_window=f.create_window(850,500,window=ic1,anchor=NW)

                    def b():
                        st.insert(END,"\nthe apparatus (-_-)->(>_<)->(*,*) ")
                        f.create_text(1000,480,text="please give feedback of the game",fill="yellow")
                        T=Entry(gg, width=40 )
                        T_window=f.create_window(900,500,window=T,anchor=NW)
                        h=Button(gg,text="enter")
                        h_window=f.create_window(900,550,anchor=NW,window=h)
                        def read():
                            l=[]
            ...
            def go():
                def TrailAction():
                    ...
                    c11 = Checkbutton(gg, text="2).look around to find more clues")
                    c10_window=f.create_window(850,450,window=c10,anchor=NW)
                    c11_window=f.create_window(850,500,window=c11,anchor=NW)

                    def seeCart():
                        c1_window=f.create_window(20,350,anchor=NW,window=I5)
                        c10.destroy()
                        c11.destroy()
                        st.insert(END, "\n the cart is there ")
                        c14 = Checkbutton(gg, text="check inside the cart")
                        c14_window=f.create_window(850,450,window=c14,anchor=NW)
                        c15 = Checkbutton(gg, text="check outside")
                        c15_window=f.create_window(850,500,window=c15,anchor=NW)
                        c16 = Checkbutton(gg, text="go back")
                        c16_window=f.create_window(850,550,window=c16,anchor=NW)
                        ...
                        def apparatus():
                            ...
                            c15.destroy()
                            c16.destroy()
                            st.insert(END, "hmm there is a paper,lets see what is written in that ")
                            st.insert(END,
    ...
    def beginning():
        ...
        def bar():
            ...
            def leave():
                st.insert(END, "\nWhat do you want to do?")
                c3 = Checkbutton(gg, text="1)hang around looking for more info")
                ...
                def leaveBar():
                    ...
                    def inner():
                        ...
                        c_window=f.create_window(850,450,window=c5,anchor=NW)
                        c_window=f.create_window(850,500,window=c6,anchor=NW)
                        ...
                        def home():
                            ...
                            def checkHome():
                                ...
                                def inner1():
                                    st.insert(END, "\nWhat do you want to do?\n")
                                    c1_window=f.create_window(20,350,anchor=NW,window=I4)
                                    ...
                                    c7_window=f.create_window(850,450,window=c7,anchor=NW)
                                    c8_window=f.create_window(850,500,window=c8,anchor=NW)
                                    c9_window=f.create_window(850,550,window=c9,anchor=NW)
                                    ...
                                    def cart():
                                        ...
                                        def TrailAction():
                                            ...
                                            c1_window=f.create_window(20,350,anchor=NW,window=I7)
                                            c10_window=f.create_window(850,450,window=c10,anchor=NW)
                                            c11_window=f.create_window(850,500,window=c11,anchor=NW)
                                            ...
                                            def seeCart():
                                                ...
                                                c1_window=f.create_window(2000,350,anchor=NW,window=I7)

                                                def checkCart():
                                                    c1_window=f.create_window(20,350,anchor=NW,window=I5)
                                                    st.insert(END, "\nwant to check the cart?")
                                                    l1 = Checkbutton(f, text="y")
                                                    l1_window=f.create_window(850,450,window=l1,anchor=NW)
                                                    l2 = Checkbutton(f, text="n")
                                                    l2_window=f.create_window(850,500,window=l2,anchor=NW)
                                                    ...
                                                    def chestOpenTrial():
                                                        ...
                                                        def paper():
                                                            ...
                                                            o1 = Checkbutton(f, text="try to open the chest")
                                                            o1_window=f.create_window(850,450,window=o1,anchor=NW)
                                                            o2 = Checkbutton(f, text="see the paper")
                                                            o2_window=f.create_window(850,500,window=o2,anchor=NW)
                                                            ...
                                                            def puzzleSolve():
                                                                ...
                                                                o3 = Checkbutton(f, text="yes")
                                                                o3_window=f.create_window(850,450,window=o3,anchor=NW)
                                                                o4 = Checkbutton(f, text="no")
                                                                o4_window=f.create_window(850,500,window=o4,anchor=NW)
                                                                ...
                                                                def sudokuOpen():
                                                                    ...
                                                                    def sike():
                                                                        p = Tk()
                                                                        p.configure(background="purple")
                                                                        b = Button(p, text="enter")
                                                                        p.title("solve this puzzle")
                                                                        nicex = []
                                                                        nicey = []
                                                                        nice = []
                                                                        y = 0
                                                                        ...
                                                                        def enter():
                                                                            y = random.sample(nice, 4)
                                                                            g = Label(p,
                                                                                      text="the password is in this coordinates")
                                                                            g.grid(row=0, column=11)
                                                                            k = 0
                                                                            for g in y:
                                                                                y[k] = str(y[k])
                                                                                g = Label(p, text=f'{g}]{d[g]}')
                                                                                g.grid(row=1 + k, column=11)
                                                                                k += 1
                                                                                e = Entry(p,
                                                                                          text="enter the password here",
                                                                                          width=20)
                                                                                e.grid(row=6, column=11)
                                                                            co = Button(p, text="continue")
                                                                            co.grid(row=6, column=12)
                                                                            ...
                                                                            def check():
                                                                                ...
                                                                                if g == x:
                                                                                    e.destroy()
                                                                                    co.destroy()
                                                                                    f = Label(p, text="correct!!")
                                                                                    f.grid(row=6, column=31)
                                                                                    con1 = Button(p,
                                                                                                  text="continue the game")
                                                                                    con1.grid(row=7, column=11)

                                                                                    def des():
                                                                                        p.destroy()
                                                                                        lastpart()

                                                                                    con1.configure(command=des)
                                                                                else:
                                                                                    x = Label(p, text="try again")
                                                                                    enter()

                                                                            co.config(command=check)

                                                                        b.grid(row=75, column=40)
                                                                        b.config(command=enter)
                                                                        p.mainloop()
                                                                ...
                                                                o3.configure(command=sudokuOpen)
                                                                o4.configure(command=chestOpenTrial)
                                                            ...
                                                            o1.configure(command=chestLock)
                                                            o2.configure(command=puzzleSolve)
                                                    ...
                                                    l1.configure(command=chestOpenTrial)
